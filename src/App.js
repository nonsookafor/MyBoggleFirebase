      ...
      <Router>
        <Routes>
          ...
          <Route path="/game" element={<Game setTotalWords={(totalWords) => setTotalWords(totalWords)} chosenWords={chosenWords} solution={solution} missedWords={missedWords} setMissedWords={(missedWords) => setMissedWords(missedWords)} gridNumber={gridNumber}  setTime={(time) => setTime(time)} setChosenWords={(chosenWords) => setChosenWords(chosenWords)} setSolution={(solution) => setSolution(solution)} />} />
					<Route path="/details" element={<Details highScore1={highScore1} setHighScore1={(highScore1) => setHighScore1(highScore1)} setTotalWords={(totalWords) => setTotalWords(totalWords)} chosenWords={chosenWords} solution={solution} missedWords={missedWords} setMissedWords={(missedWords) => setMissedWords(missedWords)} setGridNumber={(gridNumber) => setGridNumber(gridNumber)} setTime={(time) => setTime(time)} setChosenWords={(chosenWords) => setChosenWords(chosenWords)} setSolution={(solution) => setSolution(solution)} gridNumber={gridNumber} totalWords={totalWords} time={time} />} />
